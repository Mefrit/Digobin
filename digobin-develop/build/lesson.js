...
define("lib/audio", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.loadSpriteTiming = exports.loadTiming = exports.loadAudio = exports.AudioSprites = exports.AudioFragment = void 0;
...
define("lib/dom", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.clear = exports.show = exports.hide = exports.el = exports.toggle = void 0;
...
define("lib/path", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.projectName = exports.extension = exports.filename = exports.dirname = void 0;
...
define("lib/animation/person_animation", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PersonAnimation = void 0;
...
define("lib/interactive/defaultInteractive", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DefaultInteractive = void 0;
...
define("lib/interactive/InteractiveLesson2", ["require", "exports", "lib/interactive/defaultInteractive"], function (require, exports, defaultInteractive_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InteractiveLesson2 = void 0;
...
define("lib/interactive/InteractiveLesson1", ["require", "exports", "lib/interactive/defaultInteractive"], function (require, exports, defaultInteractive_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InteractiveLesson1 = void 0;
...
define("lib/interactive/InteractiveLesson3", ["require", "exports", "lib/interactive/defaultInteractive"], function (require, exports, defaultInteractive_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InteractiveLesson3 = void 0;
...
define("lib/interactive/InteractiveLesson4", ["require", "exports", "lib/interactive/defaultInteractive"], function (require, exports, defaultInteractive_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InteractiveLesson4 = void 0;
...
define("lib/interactive/InteractiveLesson5", ["require", "exports", "lib/interactive/defaultInteractive"], function (require, exports, defaultInteractive_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InteractiveLesson5 = void 0;
...
define("lib/interactive/configInteractive", ["require", "exports", "lib/interactive/InteractiveLesson2", "lib/interactive/InteractiveLesson1", "lib/interactive/InteractiveLesson3", "lib/interactive/InteractiveLesson4", "lib/interactive/InteractiveLesson5"], function (require, exports, InteractiveLesson2_1, InteractiveLesson1_1, InteractiveLesson3_1, InteractiveLesson4_1, InteractiveLesson5_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.arrInteractiveLesson = void 0;
...
define("lib/animation/eyes", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EyesAnimation = void 0;
    function show(list, key) {
        for (var i in list) {
            if (list.hasOwnProperty(i)) {
                list[i].node.style.display = i == key ? "block" : "none";
    ...
    exports.EyesAnimation = EyesAnimation;
});
define("lib/interactive/interactiveEntry", ["require", "exports", "lib/interactive/defaultInteractive"], function (require, exports, defaultInteractive_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.InteractiveEntry = void 0;
    class InteractiveEntry extends defaultInteractive_6.DefaultInteractive {
        constructor(obj) {
            super(obj);
            this.getLesson = () => {
                return "entry";
    ...
    exports.InteractiveEntry = InteractiveEntry;
});
define("lesson", ["require", "exports", "react", "react-dom", "lib/story", "lib/loader", "lib/scene", "lib/audio", "lib/url", "lib/resize"], function (require, exports, React, ReactDOM, story_1, loader_1, scene_1, audio_1, url_1, resize_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class StepList extends React.Component {
        ...
        render() {
            return (React.createElement("ul", { className: "step-list" }, this.props.list.map((name) => (React.createElement("li", { className: this.state.active == name ? "step__item--active" : "", onClick: this.onSelect.bind(null, name) }, name)))));
        }
    }
    ...
    function changeLesson(config, lesson) {
        rs.load(config.scene)
            ...
            .then((data) => audio_1.loadAudio("../assets/projects/" + lesson + "/audio/", "digobin"))
            .then((result) => {
            story.roles.digobin.audio = result;
        })
            .then(() => audio_1.loadAudio("../assets/projects/" + lesson + "/audio/", "professor"))
            .then((result) => {
            story.roles.professor.audio = result;
        })
            .then(() => audio_1.loadSpriteTiming("../assets/projects/" + lesson + "/speak/digobin.json"))
            .then((list) => {
            story.roles.digobin.timing = list;
        })
            .then(() => audio_1.loadSpriteTiming("../assets/projects/" + lesson + "/speak/professor.json"))
            .then((list) => {
            ...
            let hash = convertToHash(result.data), params = url_1.getUrlParams(window.location.search);
            story.set(hash);
            story.play("intro");
            if (params.mode == "development") {
                ReactDOM.render(React.createElement(StepList, { list: Object.keys(hash) }), document.getElementById("step-group"));
